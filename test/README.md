...
The primary-path test runs 178 predeclared checks in a browser. Chrome and `puppeteer-core`
...
`PLANNED` at the top of the file names all 178 assertions, and the summary line
