...
full request→reply round trip per contract-C message type. 436 checks, all of
...
The primary-path test runs 169 predeclared checks in a browser. Chrome and `puppeteer-core`
...
`PLANNED` at the top of the file names all 169 assertions, and the summary line
