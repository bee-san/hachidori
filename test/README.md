...
full request→reply round trip per contract-C message type. 406 checks, all of
...
The primary-path test runs 160 predeclared checks in a browser. Chrome and `puppeteer-core`
...
`PLANNED` at the top of the file names all 160 assertions, and the summary line
