...
function fixture(firstAudio = false) {
  const calls = [];
  let fields, generation = 3, changeDuringCheck = false;
  ...
  return { service, calls, request, changedGeneration() { generation++; }, duringCheck() { changeDuringCheck = true; }, get fields() { return fields; } };
}
