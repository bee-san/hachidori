...
function dictionariesView() {
  ...
  const installingView = () => ({
    ...
    body: [paragraph("These five dictionaries get you started. Installation continues if you close this tab; use Resume setup in Settings to return."), rows, importNote],
    actions: [],
  });
