...
function render() {
  ...
  elements["activation-hint"].textContent = !options.hoverEnabled ? "Lookups paused"
    : options.lookupMode === "activation" ? `Hold ${options.activationKey} to scan` : "Hover over Japanese text to scan";
}
